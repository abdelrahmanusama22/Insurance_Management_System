    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <h2 class="mb-4 text-center text-dark fw-bold animate__animated animate__fadeInDown">
                <i class="fas fa-building me-2"></i> إضافة مكتب تأمين جديد
            </h2>

            <div class="card-container animate__animated animate__fadeInUp">
                <div class="card-header">
                    <i class="fas fa-plus-circle me-2"></i> بيانات مكتب التأمين
                </div>
                <div class="card-body">
                    <form action="{{ route('insurance_offices.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('register_number') is-invalid @enderror" id="register_number" name="register_number" value="{{ old('register_number') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('area2') is-invalid @enderror" id="area2" name="area2" value="{{ old('area2') }}">
                                @error('area2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('police_officer') is-invalid @enderror" id="police_officer" name="police_officer" value="{{ old('police_officer') }}">
